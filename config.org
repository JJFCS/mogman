...
(use-package minibuffer
    ...
    (setq completion-styles '(partial-completion flex initials))  ;; TODO - THIS VS ORDERLESS
...
(use-package org-remark :defer t
    :ensure t
    :config
    (org-remark-global-tracking-mode 1)  ;; auto saves & restores highlights across emacs sessions
    (org-remark-create "blue" '(:background "blue"))
    (org-remark-create "pink" '(:background "deep pink")))
...
(defvar onncera-o-map (make-sparse-keymap) "onncera C-c o prefix")  ;; org mode
(global-set-key (kbd "C-c o") onncera-o-map)
(define-key onncera-o-map (kbd "m") #'org-remark-mark)
(define-key onncera-o-map (kbd "b") #'org-remark-mark-blue)
(define-key onncera-o-map (kbd "p") #'org-remark-mark-pink)
(define-key onncera-o-map (kbd "u") #'org-remark-mark-yellow)
(define-key onncera-o-map (kbd "r") #'org-remark-remove)
