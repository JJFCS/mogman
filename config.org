...
(defun onncera-create-editorconfig ()
    "create a .editorconfig file in the current project directory"
    (interactive)
    (let*
        ...
        (
            ...
            (file (expand-file-name ".editorconfig" dir))
        )

    (if (file-exists-p file)
        (message "no need create. one exists.")
        (with-temp-file file
            (insert
            "root = true\n"
            "\n"
...
(use-package minibuffer
    ...
    (setq completion-styles '(partial-completion flex initials)))  ;; TODO - not sure if I want to use this or orderless..
...
(define-key onncera-a-map (kbd "e") #'oncnera-create-editorconfig)
