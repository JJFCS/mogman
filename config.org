...
$ function 4
#+begin_src emacs-lisp
(defun onncera-insert-dagger () (interactive) (insert "†"))
...
(with-eval-after-load 'consult
    (dolist (face (face-list))
        (when (string-prefix-p "consult-" (symbol-name face))
            (set-face-attribute face nil :slant 'normal))))  ;; removes italics
#+end_src
...
(define-key onncera-u-map (kbd "b") #'onncera-insert-dagger)  ;; blue highlights
